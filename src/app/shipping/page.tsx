  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-10">
        {[
          { icon: Truck, t: 'Free over $250', d: 'Complimentary shipping on qualifying orders.' },
      ...
      <div className="prose prose-gray max-w-none text-gray-700 text-sm leading-relaxed space-y-4">
        ...
        <p>Free shipping applies to all orders over $250. For orders below that threshold, shipping is calculated and confirmed by our team before dispatch.</p>
