...
const faqs = [
  ...
  { q: 'Do you offer free shipping?', a: 'Yes — your first order always ships free. After that, shipping is complimentary on all orders over $800; other orders ship at a flat $50 rate.' },
